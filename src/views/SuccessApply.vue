  ...
  <v-container>
    <v-row>
      <v-col class="mx-auto mt-16" cols="12">
        <v-card class="mx-auto mt-16" max-width="800" elevation="1" min-height="300">
          <v-card-title class="mx-auto mt-16 pt-16">
...
export default {
  ...
  data(){
    return{
        ...
        StatusActivation:"Your Application has been sent Successfully, the employer will contact you if you are short-listed.Thank You and good luck in your application",
